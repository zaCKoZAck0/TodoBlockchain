...
const SideNav: FC<SideNavProps> = ({ isOpen, onClose }) => {
  return (
    ...
    >
      <div className="border-r-2 flex flex-col justify-between border-gray bg-black text-white w-64 h-[96vh] fixed top-0 left-0 z-50">
        <div>
        <div className='flex justify-between m-8 mb-0'>
        <div className='flex'>
...
</svg> <span className='ml-2 text-[24px]'>Name</span>
        </div>
...
<path d="M22.2588 4.7211H13.2588" stroke="#808191" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path opacity="0.301406" d="M22.2588 19.8724H13.2588" stroke="#808191" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M7.25879 7.56198L2.25879 12.2968L7.25879 17.0315" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
        </button></div>
        <ul className="pt-7 text-lg font-normal text-textGrayLight">
          <li className="flex p-2 my-2 mx-2 hover:bg-gray hover:text-white transition-all cursor-pointer duration-300 rounded-[12px]">
            <svg className="translate-y-1 mx-5" width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<a href="/">Home</a>
            ...
            <li className="flex p-2 my-2 hover:bg-gray hover:text-white transition-all cursor-pointer duration-300 mx-2 rounded-[12px]">
            <svg className="translate-y-1 mx-5" width="22" height="21" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <li className="flex p-2 my-2 mx-2 hover:bg-gray hover:text-white transition-all cursor-pointer duration-300 rounded-[12px]">
            <svg className="translate-y-1 mx-5" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className="flex p-2 my-2 hover:bg-gray hover:text-white transition-all cursor-pointer duration-300 mx-2 rounded-[12px]">
            <svg className="translate-y-1 mx-5" width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className="flex p-2 my-2 mx-2 bg-gray cursor-pointer text-white rounded-[12px]">
            <svg className="translate-y-1 mx-5" width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M5.59875 7.59453L11.1988 4.08081" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M11.1988 13.9192L5.59875 10.4055" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            <a href="/">Section 8</a>
          </li>
        </ul>
