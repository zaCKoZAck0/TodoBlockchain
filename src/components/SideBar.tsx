...
const {editingNote, setEditOpen, setRefresh, setEditingNote } = useContext(ListContext);
...
>
      <div className="border-l-2 border-t-4 border-gray bg-black text-white w-80 h-screen fixed top-0 right-0 z-50">
        ...
        onClick={()=>{
          setEditOpen && setEditOpen(false)
          setEditingNote && setEditingNote(null)
          }} className='mr-3 cursor-pointer' width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
